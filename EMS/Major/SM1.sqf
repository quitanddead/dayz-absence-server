...
//_position2 = [getMarkerPos "center",0,5500,100,0,20,0] call BIS_fnc_findSafePos;
...
//Mission start
[nil,nil,rTitleText,localize "STR_MajorM1", "PLAIN",10] call RE;
missiontext = localize "STR_MajorM1short";
Ccoords = _position2;
publicVariable "Ccoords";
[] execVM "debug\addmarkers.sqf";

_hummer = createVehicle ["UAZ_Unarmed_UN_EP1",[(_position2 select 0) + 10, (_position2 select 1) - 20,0],[], 0, "CAN_COLLIDE"];
_hummer1 = createVehicle ["UAZ_Unarmed_UN_EP1",[(_position2 select 0) + 20, (_position2 select 1) - 10,0],[], 0, "CAN_COLLIDE"];
_hummer2 = createVehicle ["SUV_Camo",[(_position2 select 0) + 30, (_position2 select 1) + 10,10],[], 0, "CAN_COLLIDE"];

_hummer setVariable ["Sarge",1,true];
_hummer1 setVariable ["Sarge",1,true];
_hummer2 setVariable ["Sarge",1,true];

_crate = createVehicle ["USVehicleBox",_position2,[], 0, "CAN_COLLIDE"];
...
//Mission completed
[nil,nil,rTitleText,localize "STR_MajorM1end", "PLAIN",6] call RE;
