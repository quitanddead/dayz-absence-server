...
_marker3 = ['sidezone2', 100, _position2, 'ColorRED', 'ELLIPSE', 'FDIAGONAL', '', 0, '', false] call WC_fnc_createmarkerlocal2;
	_marker3 = ["bombzone2", _marker3] call WC_fnc_copymarkerlocal2;
...
diag_log "EMS: Major Mission Created (SM14)";

//Mission start
[nil,nil,rTitleText,localize "STR_MajorM14", "PLAIN",6] call RE;
missiontext = localize "STR_MajorM14short";
Ccoords = _position2;
publicVariable "Ccoords";
[] execVM "debug\addmarkers.sqf";
			_vehicle = createVehicle ["MAZ_543_SCUD_TK_EP1", _position2, [], 0, "NONE"];
...
[nil,nil,rHINT,_text] call RE;
			...
			wcgarbage = [_vehicle, 0.15] spawn WC_fnc_destroyvehicle2;
