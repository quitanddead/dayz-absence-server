...
//_position2 = [getMarkerPos "center",0,3200,100,0,20,0] call BISfnc_findSafePos;
...
//Mission start
[nil,nil,rTitleText,localize "STR_MajorM11", "PLAIN",6] call RE;
missiontext = localize "STR_MajorM11short";
Ccoords = _position2;
...
//Mission completed
[nil,nil,rTitleText,localize "STR_MajorM11end", "PLAIN",6] call RE;
