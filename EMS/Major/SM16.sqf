...
diag_log "EMS: Major Mission Created (SM16)";

//Mission start
[nil,nil,rTitleText,localize "STR_MajorM16", "PLAIN",6] call RE;
missiontext = localize "STR_MajorM16short";
Ccoords = _position2;
...
[nil,nil,rHINT,_text] call RE;
			...
			_vehicle addEventHandler ['killed',{_this execVM "\z\addons\dayz_server\EMS\bodyclean2.sqf"}]; //Body disappear timeBomb
...
//Mission completed
[nil,nil,rTitleText,localize "STR_MajorM16end", "PLAIN",6] call RE;
