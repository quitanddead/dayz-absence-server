...
_marker3 = ['sidezone2', 100, _position2, 'ColorRED', 'ELLIPSE', 'FDIAGONAL', '', 0, '', false] call WC_fnc_createmarkerlocal2;
	_marker4 = ["bombzone2", _marker3] call WC_fnc_copymarkerlocal;
...
[nil,nil,rTitleText,localize "STR_MajorM10", "PLAIN",6] call RE;
missiontext = localize "STR_MajorM10short";
Ccoords = _position2;
...
sleep 5;
_aispawn = [_position2,80,6,4,1] execVM "\z\addons\dayz_server\EMS\add_unit_server2.sqf";//AI Guards
sleep 5;
...
//Mission completed
[nil,nil,rTitleText,localize "STR_MajorM10end", "PLAIN",6] call RE;
