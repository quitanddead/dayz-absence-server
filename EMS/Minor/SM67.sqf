...
diag_log "EMS: Minor mission created (SM67)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM67", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM67short";
MCoords = _position;
...
[] execVM "debug\addmarkers75.sqf";
			...
			_vehicle = (nearestObjects [_position, ["Land_ss_hangar"], 400]) call BIS_fnc_selectRandom;
						_vname = "Land_ss_hangar";
			//_name = gettext (configFile >> "CfgVehicles" >> _vname >> "DisplayName");
			_picture = "\z\addons\dayz_code\pics\Land_ss_hangar.paa";
_text = parseText format ["<t color='#FFCC33'>+3000 humanity</t><br/><br/><img size='5' image='%1'/><br/><br/><t color='#FFCC33'>Secure</t>", _picture];
