...
diag_log "EMS: Minor mission created (SM31)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM31", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM31short";
MCoords = _position;
...
[] execVM "debug\addmarkers75.sqf";
			...
			_picture = "\z\addons\dayz_code\pics\ZU23_ins.paa";
