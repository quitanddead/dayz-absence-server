...
diag_log "EMS: Minor mission created (SM70)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM70", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM70short";
MCoords = _position;
...
[] execVM "debug\addmarkers75.sqf";
			...
			_vehicle2 = _group createUnit ["ins_lopotev", _position, [], 0, "NONE"];
						_vname = "ins_lopotev";
			_name = gettext (configFile >> "CfgVehicles" >> _vname >> "DisplayName");
			_picture = "\z\addons\dayz_code\pics\record.paa";
_text = parseText format ["<t color='#FFCC33'>+7000 humanity</t><br/><br/><img size='5' image='%1'/><br/><br/><t color='#FFCC33'>Record</t>", _picture];
