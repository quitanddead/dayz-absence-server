...
diag_log "EMS: Minor mission created (SM63)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM63", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM63short";
MCoords = _position;
...
[] execVM "debug\addmarkers75.sqf";
			...
			_picture = "\z\addons\dayz_code\pics\su25_ins.paa";
