...
diag_log "EMS: Minor mission created (SM19)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM19", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM19short";
MCoords = _position;
...
[] execVM "debug\addmarkers75.sqf";
	...
	_vehicle = createVehicle ["Ural_ZU23_ins", _position, [], 0, "NONE"];
			...
			_picture = "\z\addons\dayz_code\pics\Ural_ZU23_ins.paa";
