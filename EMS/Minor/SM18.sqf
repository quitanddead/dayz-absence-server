...
diag_log "EMS: Minor mission created (SM18)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM18", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM18short";
MCoords = _position;
...
[] execVM "debug\addmarkers75.sqf";
	...
	_vehicle = createVehicle ["UralRefuel_INS", _position, [], 0, "NONE"];
			...
			_picture = "\z\addons\dayz_code\pics\UralRefuel_INS.paa";
