...
diag_log "EMS: Minor mission created (SM28)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM28", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM28short";
MCoords = _position;
	...
	_group = createGroup east;
			...
			_name = gettext (configFile >> "CfgVehicles" >> _vname >> "DisplayName");
				switch _type do {
					...
					case "GUE_Soldier_Sab": {
					_picture = "\z\addons\dayz_code\pics\GUE_Soldier_Sab.paa";
				};	
					case "Madam3": {
					_picture = "\z\addons\dayz_code\pics\Madam3.paa";
				};	
					case "GUE_Commander": {
					_picture = "\z\addons\dayz_code\pics\GUE_Commander.paa";
				};
		};
...
//Mission completed
[nil,nil,rTitleText,localize "STR_MinorM28end", "PLAIN",6] call RE;
