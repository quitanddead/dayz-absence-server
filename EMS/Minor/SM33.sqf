...
diag_log "EMS: Minor mission created (SM33)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM33", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM33short";
MCoords = _position;
...
[] execVM "debug\addmarkers75.sqf";
			...
			_picture = "\z\addons\dayz_code\pics\PowGen_Big.paa";
