...
diag_log "EMS: Minor mission created (SM27)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM27", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM27short";
MCoords = _position;
...
[] execVM "debug\addmarkers75.sqf";
	...
	_vehicle = createVehicle ["Land_Misc_Cargo1E_EP1", _position, [], 0, "NONE"];
			...
			_picture = "\z\addons\dayz_code\pics\Land_Misc_Cargo1E_EP1.paa";
