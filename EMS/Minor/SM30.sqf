...
diag_log "EMS: Minor mission created (SM30)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM30", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM30short";
MCoords = _position;
...
[] execVM "debug\addmarkers75.sqf";
			...
			_vehicle = _group createUnit ["Ins_Commander", _position, [], 0, "NONE"];
						_vname = "Ins_Commander";
			_name = gettext (configFile >> "CfgVehicles" >> _vname >> "DisplayName");
			_picture = "\z\addons\dayz_code\pics\Ins_Commander.paa";
...
//Mission completed
[nil,nil,rTitleText,localize "STR_MinorM30end", "PLAIN",6] call RE;
