...
diag_log "EMS: Minor mission created (SM60)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM60", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM60short";
MCoords = _position;
publicVariable "MCoords";
[] execVM "debug\addmarkers75.sqf";

			_hangar = (nearestObjects [_position, ["Land_SS_hangar"], 400]) call BIS_fnc_selectRandom;
			_vehicle = "Su34_DZA" createvehicle position _hangar;
						_vname = typeof _vehicle;
			_name = gettext (configFile >> "CfgVehicles" >> _vname >> "DisplayName");
			_picture = "\z\addons\dayz_code\pics\su34.paa";
