...
diag_log "EMS: Minor mission created (SM11)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM11", "PLAIN",6] call RE;
missiontext75 = localize "STR_MinorM11short";
MCoords = _position;
publicVariable "MCoords";
[] execVM "debug\addmarkers75.sqf";

humveecrash = createVehicle ["HMMWVwreck",_position,[], 0, "CAN_COLLIDE"];
humveecrash setVariable ["Sarge",1,true];
wcgarbage = [humveecrash] spawn WC_fnc_protectobject;
...
[_position,40,4,3,1] execVM "\z\addons\dayz_server\EMS\add_unit_server3.sqf";//AI Guards
sleep 1;
...
//Mission completed
[nil,nil,rTitleText,localize "STR_MinorM11end", "PLAIN",6] call RE;
