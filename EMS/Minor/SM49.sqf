...
diag_log "EMS: Minor mission created (SM49)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM49", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM49short";
MCoords = _position;
publicVariable "MCoords";
[] execVM "debug\addmarkers75.sqf";

			_vehicle = createVehicle ["Ka52_DZA", _position, [], 0, "NONE"];
						_vname = typeof _vehicle;
			_name = gettext (configFile >> "CfgVehicles" >> _vname >> "DisplayName");
			_picture = "\z\addons\dayz_code\pics\ka52.paa";
