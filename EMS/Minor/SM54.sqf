...
diag_log "EMS: Minor mission created (SM54)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM54", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM54short";
MCoords = _position;
publicVariable "MCoords";
[] execVM "debug\addmarkers75.sqf";

			_vehicle = createVehicle ["Mi17_rockets_DZA", _position, [], 0, "NONE"];
