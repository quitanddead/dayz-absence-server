...
diag_log "EMS: Minor mission created (SM22)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM22", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM22short";
MCoords = _position;
...
[] execVM "debug\addmarkers75.sqf";
	...
	_vehicle = createVehicle ["Land_Ind_TankSmall2_EP1", _position, [], 0, "NONE"];
			...
			_picture = "\z\addons\dayz_code\pics\Land_Ind_TankSmall2_EP1.paa";
