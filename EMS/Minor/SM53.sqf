...
diag_log "EMS: Minor mission created (SM53)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM53", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM53short";
MCoords = _position;
...
[] execVM "debug\addmarkers75.sqf";
			...
			_picture = "\z\addons\dayz_code\pics\TKVehicleBox_EP1.paa";
