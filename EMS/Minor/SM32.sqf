...
diag_log "EMS: Minor mission created (SM32)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM32", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM32short";
MCoords = _position;
...
[] execVM "debug\addmarkers75.sqf";
			...
			_picture = "\z\addons\dayz_code\pics\GRAD_ins.paa";
