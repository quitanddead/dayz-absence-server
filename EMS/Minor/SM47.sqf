...
diag_log "EMS: Minor mission created (SM47)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM47", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM47short";
MCoords = _position;
publicVariable "MCoords";
[] execVM "debug\addmarkers75.sqf";

_group = createGroup east;
			_vehicle = _group createUnit ["Ins_Lopotev", _position, [], 0, "NONE"];
						_vname = "Ins_Lopotev";
			_name = gettext (configFile >> "CfgVehicles" >> _vname >> "DisplayName");
			_picture = "\z\addons\dayz_code\pics\lopotev.paa";
