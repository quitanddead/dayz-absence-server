...
diag_log "EMS: Minor mission created (SM55)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM55", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM55short";
MCoords = _position;
...
[] execVM "debug\addmarkers75.sqf";
			...
			_picture = "\z\addons\dayz_code\pics\damsel4.paa";
...
[nil,nil,rTitleText,localize "STR_MinorM55end, "PLAIN",6] call RE;
{
