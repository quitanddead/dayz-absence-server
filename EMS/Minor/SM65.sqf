...
diag_log "EMS: Minor mission created (SM65)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM65", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM65short";
MCoords = _position;
...
_text = parseText format ["<t color='#FFCC33'>+2000 humanity</t><br/><br/><img size='5' image='%1'/><br/><br/><t color='#FFCC33'>Heal</t>", _picture];
