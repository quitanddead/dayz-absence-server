...
diag_log "EMS: Minor mission created (SM17)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM17", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM17short";
MCoords = _position;
publicVariable "MCoords";
[] execVM "debug\addmarkers75.sqf";

	_vehicle = createVehicle ["Barrack2", _position, [], 0, "NONE"];
