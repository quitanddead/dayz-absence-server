...
diag_log "EMS: Minor mission created (SM39)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM39", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM39short";
MCoords = _position;
...
[] execVM "debug\addmarkers75.sqf";
			...
			_picture = "\z\addons\dayz_code\pics\zsu_ins.paa";
