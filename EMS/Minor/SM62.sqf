...
diag_log "EMS: Minor mission created (SM62)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM62", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM62short";
MCoords = _position;
...
[] execVM "debug\addmarkers75.sqf";
			...
			_vehicle = "Mi24_V_DZA" createvehicle position _hangar;
						_vname = typeof _vehicle;
			_name = gettext (configFile >> "CfgVehicles" >> _vname >> "DisplayName");
			_picture = "\z\addons\dayz_code\pics\mi24_v.paa";
