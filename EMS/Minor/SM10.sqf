...
//Mission start
[nil,nil,rTitleText,localize "STR_MinorM10", "PLAIN",6] call RE;
missiontext75 = localize "STR_MinorM10short";
MCoords = _position;
publicVariable "MCoords";
[] execVM "debug\addmarkers75.sqf";

chopcrash = createVehicle ["Land_mi8_crashed",_position,[], 0, "CAN_COLLIDE"];
chopcrash setVariable ["Sarge",1,true];
wcgarbage = [chopcrash] spawn WC_fnc_protectobject;
...
//Mission complete
[nil,nil,rTitleText,localize "STR_MinorM10end", "PLAIN",6] call RE;
