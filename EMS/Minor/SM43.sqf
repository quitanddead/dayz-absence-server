...
diag_log "EMS: Minor mission created (SM43)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM43", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM43short";
MCoords = _position;
publicVariable "MCoords";
[] execVM "debug\addmarkers75.sqf";

			_vehicle = createVehicle ["BTR90_DZA", _position, [], 0, "NONE"];
						_vname = typeof _vehicle;
			_name = gettext (configFile >> "CfgVehicles" >> _vname >> "DisplayName");
			_picture = "\z\addons\dayz_code\pics\btr90.paa";
