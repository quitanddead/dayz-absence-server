...
diag_log "EMS: Minor mission created (SM36)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM36", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM36short";
MCoords = _position;
...
[] execVM "debug\addmarkers75.sqf";
			...
			_vehicle = _group createUnit ["Haris_Press_EP1", _position, [], 0, "NONE"];
						_vname = "Haris_Press_EP1";
			_name = gettext (configFile >> "CfgVehicles" >> _vname >> "DisplayName");
			_picture = "\z\addons\dayz_code\pics\Haris_Press_EP1.paa";
