...
diag_log "EMS: Minor mission created (SM52)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM52", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM52short";
MCoords = _position;
publicVariable "MCoords";
[] execVM "debug\addmarkers75.sqf";

_vehicle = createVehicle ["Mi17_DZE", _position, [], 0, "NONE"];
			_vname = typeof _vehicle;
			_name = gettext (configFile >> "CfgVehicles" >> _vname >> "DisplayName");
			_picture = "\z\addons\dayz_code\pics\Mi17_medevac_ins.paa";
