...
diag_log "EMS: Minor mission created (SM40)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM40", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM40short";
MCoords = _position;
...
[] execVM "debug\addmarkers75.sqf";
			...
			_picture = "\z\addons\dayz_code\pics\T72_TK_EP1.paa";
_text = parseText format ["<t color='#FFCC33'>+3000 humanity</t><br/><br/><img size='5' image='%1'/><br/><br/><t color='#FFCC33'>Sabotage</t>", _picture];
