...
diag_log "EMS: Minor mission created (SM21)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM21", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM21short";
MCoords = _position;
...
[] execVM "debug\addmarkers75.sqf";
	...
	_vehicle = createVehicle ["BMP2_HQ_INS_unfolded", _position, [], 0, "NONE"];
			...
			_picture = "\z\addons\dayz_code\pics\bmp2_hq_ins_unfolded.paa";
