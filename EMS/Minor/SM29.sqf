...
diag_log "EMS: Minor mission created (SM29)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM29", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM29short";
MCoords = _position;
...
//Mission completed
[nil,nil,rTitleText,localize "STR_MinorM29end", "PLAIN",6] call RE;
