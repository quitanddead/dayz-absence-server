...
diag_log "EMS: Minor mission created (SM38)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM38", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM38short";
MCoords = _position;
...
[] execVM "debug\addmarkers75.sqf";
			...
			_vehicle = _group createUnit ["CIV_EuroWoman01_EP1", _position, [], 0, "NONE"];
						_vname = "CIV_EuroWoman01_EP1";
			_name = gettext (configFile >> "CfgVehicles" >> _vname >> "DisplayName");
			_picture = "\z\addons\dayz_code\pics\CIV_EuroWoman01_EP1.paa";
