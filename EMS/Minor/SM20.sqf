...
diag_log "EMS: Minor mission created (SM20)";

//Mission start
[nil,nil,rTitleText,localize "STR_MinorM20", "PLAIN",10] call RE;
missiontext75 = localize "STR_MinorM20short";
MCoords = _position;
...
//Mission completed
[nil,nil,rTitleText,localize "STR_MinorM20end", "PLAIN",6] call RE;
