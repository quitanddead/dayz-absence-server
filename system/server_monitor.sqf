// added ability to retrieve vehicle ammo from database @long range
...
GL4_Path = "\z\addons\dayz_server\modules\GL4_System\";

[] spawn
{
	waitUntil { !(isNil "GL4_Core") };
	call compile preProcessFile "\z\addons\dayz_server\modules\GL4_Settings\GL4_Core.sqf";

	waitUntil { !(isNil "GL4_Global") };
	call compile preProcessFile "\z\addons\dayz_server\modules\GL4_Settings\GL4_Global.sqf";

	waitUntil { !(isNil "GL4_Local") };
	call compile preProcessFile "\z\addons\dayz_server\modules\GL4_Settings\GL4_Local.sqf";
};
...
if (isServer) then
{
	...
	[_b] execVM "\z\addons\dayz_server\modules\GL4_System\GL4_System.sqf";
}
else
{
