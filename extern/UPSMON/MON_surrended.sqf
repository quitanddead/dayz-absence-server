	...
	
	{
		if ( leader _x == _x ) then {
			_x addaction ["Order your men to follow me", "\z\addons\dayz_server\extern\UPSMON\actions\followme.sqf", [], 1, false];
		} else {
			_x addaction ["Follow me", "\z\addons\dayz_server\extern\UPSMON\actions\followme.sqf", [], 1, false];
		};
	}foreach _soldiers;
