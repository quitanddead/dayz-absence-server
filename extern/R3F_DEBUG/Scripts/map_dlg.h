...
class R3F_DEBUG_DLG_ShowMap
{
	...
	onLoad="uiNamespace setVariable [""VAR_R3F_DEBUG_DLG_ShowMap"", _this select 0];_void = [0,2] execVM ""extern\R3F_debug\scripts\r3f_map.sqf""";
	onUnload ="[0,2] execVM ""extern\R3F_debug\scripts\r3f_map.sqf"";";
	...
	class Ctrl_Map  : R3F_DEBUG_RscMap
    {
    	...
    	w = "SafezoneW-0.250";
    	h = "SafezoneH-0.015";
    	onMouseButtonClick = "_this execVM ""extern\R3F_debug\scripts\r3f_map.sqf"";";
    };
	...
	class Btn_Ok : R3F_DEBUG_RscBtn
	{
		...
		action = "[0,1] execVM ""extern\R3F_debug\scripts\r3f_map.sqf"";closeDialog 0;";
		x = "safeZoneX+0.015";
		y = "safeZoneY+0.045";
		w = 0.230;
	};
