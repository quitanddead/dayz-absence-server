...
{	
	...
	class R3F_DEBUG_dlg_title_icon : R3F_DEBUG_dlg_image_base
	{
		...
		//MACRO_R3f_DEBUG_POSITION_LEFT_RIGHT(-0.02, 0.140)
		MACRO_R3f_DEBUG_POSITION_LEFT_RIGHT(0, 0.140)
		//y = MACRO_R3f_DEBUG_POSITION_TOP(-0.035);
		y = MACRO_R3f_DEBUG_POSITION_TOP(-0.010);
		h = 0.160;
		text = "extern\R3F_debug\Images\r3f_debug_alpha_256.paa";
	};
