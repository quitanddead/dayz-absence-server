...
class R3FScriptDlg
{
	...
	onLoad="uiNamespace setVariable [""R3F_SCRIPT_DLG"", _this select 0];_test = [""do_init""] execVM ""extern\R3F_debug\Scripts\script_fncts.sqf""";
	onUnload ="_test = [""do_close""] execVM ""extern\R3F_debug\Scripts\script_fncts.sqf""";
	...
	class Btn_Exec : R3F_DEBUG_RscBtn
	{
		...
		default = true;
		action = "_test = [""do_exec""] execVM ""extern\R3F_debug\Scripts\script_fncts.sqf"";";
		x = 0.060;
		y = 0.920;
		w = 0.230;
	};
	...
	class Btn_Terminate : R3F_DEBUG_RscBtn
	{
		...
		action = "_test = [""do_terminate""] execVM ""extern\R3F_debug\Scripts\script_fncts.sqf"";";
		x = 0.310;
		y = 0.920;
		w = 0.230;
	};
	...
	class Btn_Raz : R3F_DEBUG_RscBtn
	{
		...
		action = "_test = [""do_raz""] execVM ""extern\R3F_debug\Scripts\script_fncts.sqf"";";
		x = 0.560;
		y = 0.920;
		w = 0.230;
	};
	...
	class Btn_Close : R3F_DEBUG_RscBtn
	{
		...
		action = "_test = [""do_close""] execVM ""extern\R3F_debug\Scripts\script_fncts.sqf"";";
		x = 0.800;
		y = 0.920;
		w = 0.230;
	};
