...
class R3FSpyDlg
{
	...
	onLoad="uiNamespace setVariable [""R3F_SPY_DLG"", _this select 0];_test = [""do_init""] execVM ""extern\R3F_debug\Scripts\spy_fncts.sqf""";
	onUnload ="";
	...
	class Spy_list :  R3F_DEBUG_List
	{
    	...
    	w = 0.335;
    	h = 0.560;
    	onLBSelChanged = "_test = [""do_select""] execVM ""extern\R3F_debug\Scripts\spy_fncts.sqf"";";
	};
	...
	class Btn_Exec : R3F_DEBUG_RscBtn
	{
		...
		default = true;
		action = "_test = [""do_add""] execVM ""extern\R3F_debug\Scripts\spy_fncts.sqf"";";
		x = 0.555;
		y = 0.290;
	};
	...
	class Btn_Raz : R3F_DEBUG_RscBtn
	{
		...
		action = "_test = [""do_del""] execVM ""extern\R3F_debug\Scripts\spy_fncts.sqf"";";
		x = 0.555;
		y = 0.340;
	};
	...
	class Btn_Close : R3F_DEBUG_RscBtn
	{
		...
		action = "_test = [""do_close""] execVM ""extern\R3F_debug\Scripts\spy_fncts.sqf"";";
		x = 0.555;
		y = 0.720;
	};
