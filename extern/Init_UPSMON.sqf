...
if (isNil("KRON_UPS_INIT") || KRON_UPS_INIT == 0) then {
	...
	call compile preprocessFileLineNumbers "\z\addons\dayz_server\extern\UPSMON\common\MON_functions.sqf";
	
	//scripts initialization
	UPSMON = compile preprocessFile "\z\addons\dayz_server\extern\UPSMON.sqf";	
