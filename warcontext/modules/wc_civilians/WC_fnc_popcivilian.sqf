	...
	while { true } do {
		...
		if(west countside list _active == 0) then {
			...
			_group = creategroup civilian;
			{
				...
				_civil setVehicleInit "this addAction ['<t color=''#ffcb00''>Руки вверх</t>', 'warcontext\actions\WC_fnc_dohandsup.sqf',[],6,false, true];";
				_civil setVehicleInit "this addAction ['<t color=''#ffcb00''>Следуй за мной</t>', 'warcontext\actions\WC_fnc_dofollowme.sqf',[],6,false, true];";
				_civil setVehicleInit "this addAction ['<t color=''#ffcb00''>Обыскать гражданского</t>', 'warcontext\actions\WC_fnc_dosearchsomeone.sqf',[],6,false, true];";
				_position = _positions call BIS_fnc_selectRandom;
