...
if (DZAI_staticAI) then {
	...
	if (DZAI_modName == "unleashed") then {
		...
		_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,2,350,thisTrigger,[],1,1] call fnc_spawnBandits;", "nul = [thisTrigger] spawn fnc_despawnBandits;"];
		_trigger_29 = _this;
		...
		_this setTriggerActivation ["ANY", "PRESENT", false];
		_this setTriggerTimeout [20, 25, 30, false];
		_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,2,450,thisTrigger,[],1,1] call fnc_spawnBandits;", "nul = [thisTrigger] spawn fnc_despawnBandits;"];
		_trigger_72 = _this;
		...
		_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,2,150,thisTrigger,[],1,1] call fnc_spawnBandits;", "nul = [thisTrigger] spawn fnc_despawnBandits;"];
		_trigger_150 = _this;
		...
		_this setTriggerStatements ["{isPlayer _x} count thisList > 0;", "nul = [0,2,550,thisTrigger,[],1,1] call fnc_spawnBandits;", "nul = [thisTrigger] spawn fnc_despawnBandits;"];
		_trigger_154 = _this;
